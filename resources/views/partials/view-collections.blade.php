        ...
        <div class="row mt-4">
            <div class="col-md-4 mb-4">
                <a href="#">
                    <div class="card card-no-border collection-wrapper">
                        <div class="d-flex">
                            <img src="/img/site/woman-white.png" alt="woman" class="collection-wrapper__img-white">
            ...
            <div class="col-md-4 mb-4">
                <a href="#">
                    <div class="card card-no-border collection-wrapper">
                        <div class="d-flex">
                            <img src="/img/site/man-white.png" alt="man" class="collection-wrapper__img-white">
